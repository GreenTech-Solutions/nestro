	...
	test: {
		...
		coverage: {
			...
			thresholds: {
				...
				'src/providers/PackagesProvider.ts': { statements: 91, branches: 81, functions: 96, lines: 91 },
				'src/providers/viewProjectionService.ts': { statements: 100, branches: 96, functions: 100, lines: 100 },
