...
- Orchestrated workflow: follow `workflow/ai-execution-plan.md`; keep `workflow/**` as local bookkeeping, use one code commit per task card, and run implementation and review through separate subagents before committing.
